...
public interface TopicinfoExtMapper {
   ...
   List<TopicinfoExt> getAllTopic(@Param("offset") Integer offset,
                                   @Param("size") Integer size);
   //查询未结
   List<TopicinfoExt> getAllTopicNotEnd(@Param("offset") Integer offset,
                                  @Param("size") Integer size);
   //查询已结
   List<TopicinfoExt> getAllTopicIsEnd(@Param("offset") Integer offset,
                                  @Param("size") Integer size);
   //查询精华
   List<TopicinfoExt> getAllTopicIsGood(@Param("offset") Integer offset,
                                  @Param("size") Integer size);
   //查询二级分类
